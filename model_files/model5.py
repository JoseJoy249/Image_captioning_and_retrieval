"""
Model5.py :  Resnet 101 encoder. Single layer LSTM with 512 hidden states. 300d Glove vectors for word embeddings, fixed
"""
import torch
...
class DecoderRNN(nn.Module):
    def __init__(self, embed_size, hidden_size, vocab_size, num_layers, weights_matrix, max_seq_length=20):
        ...
        # creating embedding layer based on glove 300d vectors
        embed_layer = nn.Embedding(vocab_size, 300)
